...
melspec_model = load_model('C:/Users/User/Downloads/cnn_melspec.h5')  # Ganti path sesuai model Anda
mfcc_model = load_model('C:/Users/User/Downloads/cnn_mfcc.h5')  # Ganti path sesuai model Anda
...
if uploaded_audio is not None:
    ...
    librosa.display.specshow(mel_db, x_axis='time', y_axis='mel', ax=ax)
    ...
    mel_spectrogram = mel_db[..., np.newaxis]  # Add channel dimension
